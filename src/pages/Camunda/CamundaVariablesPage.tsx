...
import CamundaVariablesDataGrid from "../../components/DataGrid/CamundaVariablesDataGrid";
import { ActionAlert } from "../../components/Commons/ActionAlert";

const CamundaVariablesPage = () => {
	const breadComponent = breadCrumbLinkComponent(commonBreadRoot({isBpmn:false}, false), "Variabili di processo");
...
export default CamundaVariablesPage;