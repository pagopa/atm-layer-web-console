...
import { DELETE_ASSOCIATION, DELETE_BPMN, DELETE_RES, DELETE_WR, DEPLOY_BPMN, DEPLOY_WR, DOWNLOAD_BPMN, DOWNLOAD_RES, DOWNLOAD_WR, PROCESS_RESOURCES, RESOURCES, RESOURCE_BASE_STORAGEKEY, ROLLBACK_WR, TRANSACTIONS, UPDATE_RES, UPDATE_WR, WORKFLOW_RESOURCE } from "../../commons/constants";
	...
	if (filterValues){
		Object.keys(filterValues).forEach(key => {
			if (key=== "storageKey") {
				...
				queryString = queryString.concat(`&${key}=${filterValues[key]}`);
			}
		  }
		);
	}
