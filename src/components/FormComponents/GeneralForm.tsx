...
import { Grid, TextField, Typography, useTheme, Button } from "@mui/material";
import EditNoteIcon from "@mui/icons-material/EditNote";
import { Ctx } from "../../DataContext";
import UploadFileWithButton from "../../pages/BpmnPage/UploadFileWithButton";
...
type Props={
    section: string;
    fileUploadInput?: boolean;
    fileNameInput?: boolean;
    functionTypeInput?:boolean;
};

const GeneralForm = ({section,fileUploadInput,fileNameInput,functionTypeInput}:Props) => {
					...
					>
						<Grid container item>
							...
							<Typography variant="body1" fontWeight="600">
                                Compila tutti i campi per creare un nuovo {section}
							</Typography>
						</Grid>
